...
public class TagsRecord extends UpdatableRecordImpl<TagsRecord> implements Record3<Integer, String, Integer> {
	...
	private static final long serialVersionUID = -477058588;
	...
	/**
	 * Setter for <code>public.tags.recieptid</code>.
	 */
	...
	/**
	 * Getter for <code>public.tags.recieptid</code>.
	 */
	 ...
	 */
	public TagsRecord(Integer id, String tag, Integer recieptid) {
		super(Tags.TAGS);

		setValue(0, id);
		setValue(1, tag);
		setValue(2, recieptid);
	}
}
